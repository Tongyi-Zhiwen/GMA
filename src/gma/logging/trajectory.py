...
class TrajectoryLogger:
    ...
    def log_step(
        ...
        state_update_response: str | None = None,
        state_update_error: str | None = None,
        image_caption: str | None = None,
        image_caption_response: str | None = None,
        image_caption_error: str | None = None,
        image_caption_mode: str | None = None,
        ...
        entry = {
            ...
            "image_caption_error": image_caption_error,
            "image_caption_mode": image_caption_mode,
