...
ELEMENTX_DEFAULT_SERVER_NAME = "elementx.gma.test"
        ...
        for line in ELEMENTX_HOMESERVER_YAML.read_text().splitlines():
            if line.strip().startswith("server_name:"):
                ...
                if value:
                    ...
                    return value
    _SERVER_NAME_CACHE = ELEMENTX_DEFAULT_SERVER_NAME
    return _SERVER_NAME_CACHE
...
"""
    script = (
        ...
        .replace("__SERVER_NAME__", repr(ELEMENTX_DEFAULT_SERVER_NAME))
    )
